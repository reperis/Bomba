 ...
 * @author Vakaris
 */
public class BombermanMovementRight extends BombermanMovement{
    
    public BombermanMovementRight(int speed, CustomSprite mover, Map map, int size){
    ...
    public void move() {
        ...
        p1 = this.pointMovement(points[1], 1, 0);
        p2 = this.pointMovement(points[2], 1, 0);
